...
const TheChallenge: React.FC = () => {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="2xl:mx-[300px] absolute top-[50%] right-4 text-[#AFAFAF] text-right font-sans sm:text-[20px] text-[12px] italic font-normal leading-[24px] tracking-[-0.2px] sm:max-w-[512px] max-w-xs">
